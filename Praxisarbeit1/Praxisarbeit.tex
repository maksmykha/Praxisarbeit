...
Im Jahr 2023 wuchs der globale Markt für Product Lifecycle Management und Engineering (PLM)-Software auf nahezu 28,4 Milliarden US-Dollar, was einem Wachstum von 9,6\% entspricht. Die zehn größten Anbieter hielten einen bedeutenden Marktanteil von 85,7\%, wobei Dassault Systèmes mit 17,1\% führend war.Hier sind die Top-10 PLM-Vendoren im Jahr 2023 auf dem Markt\cite{Top10PLMVendoren}:
	...
	\subsection{Phase 1: Kundenerwerbung} 
Auf dem Markt existieren diverste Anzahl von IT-Beratung von kleinen Boutiquen zu großen Unternehmen wie Capgemini und alle versuche die Kunden zu erwerben. Dafür wird diverse Möglichkeiten genutzt, wie z.B. Vertragsarten 
...
Capgemini ist ein großes Unternehmen mit verschiedenen Einheiten, die, wie bereits beschrieben, teilweise ähnliche Tätigkeiten ausführen. Die untersuchte Abteilung bei zentrelen Capgemmini\cite{Capgemini} "Product Lifecycle Management/Digital Manufacturing" verfügt über einige PLM-Demonstratoren, genauso wie andere Abteilungen in unterschiedlichen Einheiten. Allerdings besteht nur ein begrenztes Wissen über die Demonstratoren anderer Einheiten.\newline
Das Ziel des Managements ist es, eine zentrale Übersicht über alle vorhandenen PLM-Demonstratoren zu erstellen, um allen Mitarbeitern den Zugriff darauf zu ermöglichen. Dies soll nicht nur die Transparenz innerhalb des Unternehmens erhöhen, sondern auch die Kommunikation und Zusammenarbeit zwischen den Einheiten stärken.
	...
	\subsection{Phase 2: Definition}
	\subsection{Phase: Planung}
Die Phase ist der Wichtigste. Hier ist das Projekt mit den Kunden definiert und lagfristige Ziele festgestellt. Jetzt muss das Unternehmen Capgemini diese Ziele umsetzt. DAfür wählt Staffing die Mitarbeiter mit verschiedenen fürs Projekt benötigten Rollen aus\cite{wegmann2006projektmanagement}. 
...
Zudem möchte das Management die Entwicklung des Teams im Laufe des Jahres im Hinblick auf Leavers (Austritte) und Joiners (Eintritte) nachvollziehen. Da die verfügbare Datenquelle solche Informationen nicht direkt enthält, müssen diese aus den bestehenden Datenquellen abgeleitet werden. Dazu wird analysiert, in welchem Monat eine Person erstmalig oder zuletzt in den Daten erscheint. Auf Basis dieser Informationen können dann die Daten für Leavers und Joiners extrahiert und entsprechend dargestellt werden.
	...
	\newpage
	\subsection{Phase 4: Start}
	\newpage
	\subsection{Phase 5: Implementierungsphase}
	\newpage
	\subsection{Phase 6: Closure}
	\newpage
	\section{Auswertung}
